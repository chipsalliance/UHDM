...
namespace UHDM {
  ...
  class byte_var : public variables {
  public:
    ...
    unsigned int get_vpiType() { return vpiByteVar; }

    virtual unsigned int getUhdmType() { return uhdmbyte_var; }   
  private:
  ...
  class byte_varFactory {
  friend Serializer;
  public:
  static byte_var* make() {
    byte_var* obj = new byte_var();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<byte_var*> objects_;
  };
 	      
  class VectorOfbyte_varFactory {
  friend Serializer;
  public:
  static std::vector<byte_var*>* make() {
    std::vector<byte_var*>* obj = new std::vector<byte_var*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<byte_var*>*> objects_;
  };
