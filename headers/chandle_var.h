...
#ifndef CHANDLE_VAR_H
#define CHANDLE_VAR_H

namespace UHDM {

  class chandle_var : public variables {
  public:
    ...
    unsigned int get_vpiType() { return vpiChandleVar; }

    virtual unsigned int getUhdmType() { return uhdmchandle_var; }   
  private:
  ...
  class chandle_varFactory {
  friend Serializer;
  public:
  static chandle_var* make() {
    chandle_var* obj = new chandle_var();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<chandle_var*> objects_;
  };
 	      
  class VectorOfchandle_varFactory {
  friend Serializer;
  public:
  static std::vector<chandle_var*>* make() {
    std::vector<chandle_var*>* obj = new std::vector<chandle_var*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<chandle_var*>*> objects_;
  };
