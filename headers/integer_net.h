...
#ifndef INTEGER_NET_H
#define INTEGER_NET_H

namespace UHDM {

  class integer_net : public net {
  public:
    ...
    unsigned int get_vpiType() { return vpiIntegerNet; }

    virtual unsigned int getUhdmType() { return uhdminteger_net; }   
  private:
  ...
  class integer_netFactory {
  friend Serializer;
  public:
  static integer_net* make() {
    integer_net* obj = new integer_net();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<integer_net*> objects_;
  };
 	      
  class VectorOfinteger_netFactory {
  friend Serializer;
  public:
  static std::vector<integer_net*>* make() {
    std::vector<integer_net*>* obj = new std::vector<integer_net*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<integer_net*>*> objects_;
  };
