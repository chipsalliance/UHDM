...
namespace UHDM {
  ...
  class param_assign : public BaseClass {
  public:
    ...
    unsigned int get_vpiType() { return vpiParamAssign; }

    virtual unsigned int getUhdmType() { return uhdmparam_assign; }   
  private:
  ...
  class param_assignFactory {
  friend Serializer;
  public:
  static param_assign* make() {
    param_assign* obj = new param_assign();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<param_assign*> objects_;
  };
 	      
  class VectorOfparam_assignFactory {
  friend Serializer;
  public:
  static std::vector<param_assign*>* make() {
    std::vector<param_assign*>* obj = new std::vector<param_assign*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<param_assign*>*> objects_;
  };
