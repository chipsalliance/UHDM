...
#ifndef LONG_INT_VAR_H
#define LONG_INT_VAR_H

namespace UHDM {

  class long_int_var : public variables {
  public:
    ...
    unsigned int get_vpiType() { return vpiLongIntVar; }

    virtual unsigned int getUhdmType() { return uhdmlong_int_var; }   
  private:
  ...
  class long_int_varFactory {
  friend Serializer;
  public:
  static long_int_var* make() {
    long_int_var* obj = new long_int_var();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<long_int_var*> objects_;
  };
 	      
  class VectorOflong_int_varFactory {
  friend Serializer;
  public:
  static std::vector<long_int_var*>* make() {
    std::vector<long_int_var*>* obj = new std::vector<long_int_var*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<long_int_var*>*> objects_;
  };
