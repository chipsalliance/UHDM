...
namespace UHDM {
  ...
  public:
    ...
    unsigned int get_vpiType() { return vpiClassObj; }

    virtual unsigned int getUhdmType() { return uhdmclass_obj; }   
  private:
  ...
  class class_objFactory {
  friend Serializer;
  public:
  static class_obj* make() {
    class_obj* obj = new class_obj();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<class_obj*> objects_;
  };
 	      
  class VectorOfclass_objFactory {
  friend Serializer;
  public:
  static std::vector<class_obj*>* make() {
    std::vector<class_obj*>* obj = new std::vector<class_obj*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<class_obj*>*> objects_;
  };
