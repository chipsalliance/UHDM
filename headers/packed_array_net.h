...
#ifndef PACKED_ARRAY_NET_H
#define PACKED_ARRAY_NET_H

namespace UHDM {

  class packed_array_net : public net {
  public:
    // Implicit constructor used to initialize all members,
    // comment: packed_array_net();
    ~packed_array_net() final {}
    ...
    bool set_elements(VectorOfany* data) {if (!enum_struct_packed_net_groupGroupCompliant(data)) return false; elements_ = data; return true;}

    unsigned int get_vpiType() { return vpiPackedArrayNet; }

    virtual unsigned int getUhdmType() { return uhdmpacked_array_net; }   
  private:
  ...
  class packed_array_netFactory {
  friend Serializer;
  public:
  static packed_array_net* make() {
    packed_array_net* obj = new packed_array_net();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<packed_array_net*> objects_;
  };
 	      
  class VectorOfpacked_array_netFactory {
  friend Serializer;
  public:
  static std::vector<packed_array_net*>* make() {
    std::vector<packed_array_net*>* obj = new std::vector<packed_array_net*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<packed_array_net*>*> objects_;
  };
