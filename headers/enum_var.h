...
namespace UHDM {
  ...
  class enum_var : public variables {
  public:
    ...
    unsigned int get_vpiType() { return vpiEnumVar; }

    virtual unsigned int getUhdmType() { return uhdmenum_var; }   
  private:
  ...
  class enum_varFactory {
  friend Serializer;
  public:
  static enum_var* make() {
    enum_var* obj = new enum_var();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<enum_var*> objects_;
  };
 	      
  class VectorOfenum_varFactory {
  friend Serializer;
  public:
  static std::vector<enum_var*>* make() {
    std::vector<enum_var*>* obj = new std::vector<enum_var*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<enum_var*>*> objects_;
  };
