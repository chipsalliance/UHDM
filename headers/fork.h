...
namespace UHDM {
  ...
  public:
    ...
    virtual unsigned int getUhdmType() { return uhdmfork; }   
  private:
  ...
  private:
    static std::vector<fork*> objects_;
  };
 	      
  class VectorOfforkFactory {
  friend Serializer;
  public:
  static std::vector<fork*>* make() {
    std::vector<fork*>* obj = new std::vector<fork*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<fork*>*> objects_;
  };
