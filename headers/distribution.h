...
namespace UHDM {
  ...
  class distribution : public BaseClass {
  public:
    ...
    unsigned int get_vpiType() { return vpiDistribution; }

    virtual unsigned int getUhdmType() { return uhdmdistribution; }   
  private:
  ...
  friend Serializer;
  public:
  static distribution* make() {
    distribution* obj = new distribution();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<distribution*> objects_;
  };
 	      
  class VectorOfdistributionFactory {
  friend Serializer;
  public:
  static std::vector<distribution*>* make() {
    std::vector<distribution*>* obj = new std::vector<distribution*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<distribution*>*> objects_;
  };
