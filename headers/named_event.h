...
#ifndef NAMED_EVENT_H
#define NAMED_EVENT_H

namespace UHDM {

  class named_event : public BaseClass {
  public:
    ...
    unsigned int get_vpiType() { return vpiNamedEvent; }

    virtual unsigned int getUhdmType() { return uhdmnamed_event; }   
  private:
  ...
  class named_eventFactory {
  friend Serializer;
  public:
  static named_event* make() {
    named_event* obj = new named_event();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<named_event*> objects_;
  };
 	      
  class VectorOfnamed_eventFactory {
  friend Serializer;
  public:
  static std::vector<named_event*>* make() {
    std::vector<named_event*>* obj = new std::vector<named_event*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<named_event*>*> objects_;
  };
