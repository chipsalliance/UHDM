...
namespace UHDM {
  ...
  public:
    ...
    unsigned int get_vpiType() { return vpiLogicNet; }

    virtual unsigned int getUhdmType() { return uhdmlogic_net; }   
  private:
  ...
  class logic_netFactory {
  friend Serializer;
  public:
  static logic_net* make() {
    logic_net* obj = new logic_net();
    objects_.push_back(obj);
    return obj;
  }
  private:
    static std::vector<logic_net*> objects_;
  };
 	      
  class VectorOflogic_netFactory {
  friend Serializer;
  public:
  static std::vector<logic_net*>* make() {
    std::vector<logic_net*>* obj = new std::vector<logic_net*>();
    objects_.push_back(obj);
    return obj;
  }
  private:
  static std::vector<std::vector<logic_net*>*> objects_;
  };
