...
# Python API
 * When uhdm is compile as a shared library (`-DBUILD_SHARED_LIBS=ON` on `cmake` command) it also build a swig wrapper for python. The python wrapper implement almost VPI getter API from systemVerilog. See chapter *38. VPI routine definitions* of Ieee1800-2017)
