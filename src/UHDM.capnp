...
struct UhdmRoot {
  ...
  factoryNetbit @44 :List(Netbit);
  factoryStructnet @45 :List(Structnet);
  factoryEnumnet @46 :List(Enumnet);
  factoryIntegernet @47 :List(Integernet);
  factoryTimenet @48 :List(Timenet);
  factoryLogicnet @49 :List(Logicnet);
  factoryArraynet @50 :List(Arraynet);
  factoryPackedarraynet @51 :List(Packedarraynet);
  factoryLogicvar @52 :List(Logicvar);
  factoryArrayvar @53 :List(Arrayvar);
  factoryNamedevent @54 :List(Namedevent);
  factoryNamedeventarray @55 :List(Namedeventarray);
  factorySpecparam @56 :List(Specparam);
  factoryClassdefn @57 :List(Classdefn);
  factoryClasstypespec @58 :List(Classtypespec);
  factoryClassobj @59 :List(Classobj);
  factoryInterface @60 :List(Interface);
  factoryProgram @61 :List(Program);
  factoryPackage @62 :List(Package);
  factoryModule @63 :List(Module);
  factoryDesign @64 :List(Design);
