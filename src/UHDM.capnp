...
struct UhdmRoot {
  ...
  factoryIodecl @27 :List(Iodecl);
  factoryAliasstmt @28 :List(Aliasstmt);
  factoryClockingblock @29 :List(Clockingblock);
  factoryRange @30 :List(Range);
  factoryParamassign @31 :List(Paramassign);
  factoryInterfacearray @32 :List(Interfacearray);
  factoryProgramarray @33 :List(Programarray);
  factoryModulearray @34 :List(Modulearray);
  factoryGatearray @35 :List(Gatearray);
  factorySwitcharray @36 :List(Switcharray);
  factoryUdparray @37 :List(Udparray);
  factoryArraynet @38 :List(Arraynet);
  factoryLogicvar @39 :List(Logicvar);
  factoryArrayvar @40 :List(Arrayvar);
  factoryNamedevent @41 :List(Namedevent);
  factoryNamedeventarray @42 :List(Namedeventarray);
  factorySpecparam @43 :List(Specparam);
  factoryClassdefn @44 :List(Classdefn);
  factoryClasstypespec @45 :List(Classtypespec);
  factoryClassobj @46 :List(Classobj);
  factoryInterface @47 :List(Interface);
  factoryProgram @48 :List(Program);
  factoryPackage @49 :List(Package);
  factoryModule @50 :List(Module);
  factoryDesign @51 :List(Design);
...
instanceitems @12 :List(ObjIndexType);
...
instanceitems @13 :List(ObjIndexType);
propertydecls @14 :List(UInt64);
sequencedecls @15 :List(UInt64);
namedevents @16 :List(UInt64);
namedeventarrays @17 :List(UInt64);
virtualinterfacevars @18 :List(UInt64);
logicvar @19 :List(UInt64);
arrayvar @20 :List(UInt64);
arrayvarmem @21 :List(UInt64);
letdecls @22 :List(UInt64);
}
struct Forkstmt {
vpiParent @0 :UInt64;
uhdmParentType @1 :UInt64;
...
instanceitems @11 :List(ObjIndexType);
...
propertydecls @26 :List(UInt64);
sequencedecls @27 :List(UInt64);
namedevents @28 :List(UInt64);
namedeventarrays @29 :List(UInt64);
virtualinterfacevars @30 :List(UInt64);
logicvar @31 :List(UInt64);
arrayvar @32 :List(UInt64);
arrayvarmem @33 :List(UInt64);
...
instanceitems @28 :List(ObjIndexType);
propertydecls @29 :List(UInt64);
sequencedecls @30 :List(UInt64);
namedevents @31 :List(UInt64);
namedeventarrays @32 :List(UInt64);
virtualinterfacevars @33 :List(UInt64);
logicvar @34 :List(UInt64);
arrayvar @35 :List(UInt64);
arrayvarmem @36 :List(UInt64);
letdecls @37 :List(UInt64);
}
struct Modport {
vpiParent @0 :UInt64;
uhdmParentType @1 :UInt64;
...
instanceitems @50 :List(ObjIndexType);
propertydecls @51 :List(UInt64);
sequencedecls @52 :List(UInt64);
namedevents @53 :List(UInt64);
namedeventarrays @54 :List(UInt64);
virtualinterfacevars @55 :List(UInt64);
logicvar @56 :List(UInt64);
arrayvar @57 :List(UInt64);
arrayvarmem @58 :List(UInt64);
letdecls @59 :List(UInt64);
}
struct Program {
vpiParent @0 :UInt64;
uhdmParentType @1 :UInt64;
...
instanceitems @47 :List(ObjIndexType);
propertydecls @48 :List(UInt64);
sequencedecls @49 :List(UInt64);
namedevents @50 :List(UInt64);
namedeventarrays @51 :List(UInt64);
virtualinterfacevars @52 :List(UInt64);
logicvar @53 :List(UInt64);
arrayvar @54 :List(UInt64);
arrayvarmem @55 :List(UInt64);
letdecls @56 :List(UInt64);
}
struct Package {
vpiParent @0 :UInt64;
uhdmParentType @1 :UInt64;
...
instanceitems @39 :List(ObjIndexType);
propertydecls @40 :List(UInt64);
sequencedecls @41 :List(UInt64);
namedevents @42 :List(UInt64);
namedeventarrays @43 :List(UInt64);
virtualinterfacevars @44 :List(UInt64);
logicvar @45 :List(UInt64);
arrayvar @46 :List(UInt64);
arrayvarmem @47 :List(UInt64);
letdecls @48 :List(UInt64);
}
struct Module {
vpiParent @0 :UInt64;
uhdmParentType @1 :UInt64;
...
propertydecls @62 :List(UInt64);
sequencedecls @63 :List(UInt64);
namedevents @64 :List(UInt64);
namedeventarrays @65 :List(UInt64);
virtualinterfacevars @66 :List(UInt64);
logicvar @67 :List(UInt64);
arrayvar @68 :List(UInt64);
arrayvarmem @69 :List(UInt64);
letdecls @70 :List(UInt64);
}
struct Design {
vpiParent @0 :UInt64;
uhdmParentType @1 :UInt64;
