...
variables @20 :List(ObjIndexType);
parameters @21 :List(ObjIndexType);
scopes @22 :List(ObjIndexType);
typespecs @23 :List(ObjIndexType);
propertydecls @24 :List(UInt64);
sequencedecls @25 :List(UInt64);
namedevents @26 :List(UInt64);
namedeventarrays @27 :List(UInt64);
virtualinterfacevars @28 :List(UInt64);
logicvar @29 :List(UInt64);
arrayvar @30 :List(UInt64);
arrayvarmem @31 :List(UInt64);
...
concurrentassertions @22 :List(ObjIndexType);
variables @23 :List(ObjIndexType);
parameters @24 :List(ObjIndexType);
scopes @25 :List(ObjIndexType);
typespecs @26 :List(ObjIndexType);
propertydecls @27 :List(UInt64);
sequencedecls @28 :List(UInt64);
namedevents @29 :List(UInt64);
namedeventarrays @30 :List(UInt64);
virtualinterfacevars @31 :List(UInt64);
logicvar @32 :List(UInt64);
arrayvar @33 :List(UInt64);
arrayvarmem @34 :List(UInt64);
letdecls @35 :List(UInt64);
}
struct Modport {
vpiParent @0 :UInt64;
uhdmParentType @1 :UInt64;
